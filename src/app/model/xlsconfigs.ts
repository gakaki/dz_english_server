...
interface pair <K, V> {k:K;v:V;}
    ...
    export const distributions:Array<any> = [
        [1,1,0.03,0.04,0.005,0.02],[2,2,0.04,0.06,0.01,0.03],[3,3,0.06,0.08,0.02,0.04],[4,4,0.08,0.1,0.03,0.04],[5,0,0.005,0.01,0.005,0.01]
        ];

    export const shares:Array<any> = [
        [1,"大家一起来拼智力领福利",,],[2,"大家一起来拼智力领福利",,],[3,"我领取到了s%元福利，快来看看我的战绩",,],[4,"大家一起来拼智力领福利",,]
        ];
